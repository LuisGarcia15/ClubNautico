...
public class InicioController extends BaseController implements Initializable{
    ...
    void abrirCreditos(ActionEvent event) {
    	this.ventanaEmergente("CREDITOS", "FES ARAGON", "Datos_Escolares");
    }
    ...
    private void actualizarRegistro(ActionEvent event) {
    	...
    	if(indice >= 0) {
    		...
    		this.ventanaEmergente("Error", "Selecciones una fila", "Para actualizar un registro, seleccione una fila.");
    	}
    }
